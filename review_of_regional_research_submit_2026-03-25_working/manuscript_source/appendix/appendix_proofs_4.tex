\section{Proofs for Section~\ref{sec:hub_efficiency}}
...
\noindent\textbf{Part 1: the case $\Lambda_A\le 0$.}
...
\noindent\textbf{Part 2: the case $\Lambda_A>0$.}
...
\noindent\textbf{Derivative with respect to $N_A$.}
...
\noindent\textbf{Derivative with respect to $F$.}
...
\noindent\textbf{Derivative with respect to $m_A^1$.}
Starting from
\[
...
\noindent\textbf{Derivative with respect to $m_A^0$.}
Similarly,
\begin{align}
