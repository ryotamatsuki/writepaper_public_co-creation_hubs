...
The robustness discussion has an expository role distinct from the proof and the repaired global-equilibrium witness. Theorem \ref{thm:reversal} is a local sufficient-condition theorem on regular stationary branches, with its G branch anchored at a symmetric regular beta-zero full-game stationary state. The repaired witness is an all-regime computational certification at one baseline parameter vector. Neither object is a general robustness theorem.
...
The maximum defensible scope is therefore narrow: a local analytic sign-reversal theorem under the stated regularity conditions and symmetric beta-zero G anchor, plus a repaired computational global-equilibrium existence witness under the baseline functional form. No broader genericity claim is made.
