...
b=0.
\]
The purpose is to isolate the hub's value through local coordination inside region $A$ before turning in Section~\ref{sec:refresh} to the case in which the hub is combined with a cross-regional pipeline policy.
