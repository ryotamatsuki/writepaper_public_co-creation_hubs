...
\begin{enumerate}[leftmargin=2em]
    ...
    \item The efficiency thresholds from Sections~\ref{sec:hub_efficiency}--\ref{sec:refresh} all shift in favor of the hub as $\sigma$ rises. In particular, whenever the relevant thresholds are well defined, both $N_H^*(\sigma)$ and $N_{SR}^*(\sigma)$ are decreasing in $\sigma$.
\end{enumerate}
\end{proposition}
